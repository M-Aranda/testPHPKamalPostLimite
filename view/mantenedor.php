...
<html>
  ...
  <!--<script language="JavaScript"  src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.0/jquery.min.js"></script>  este es el CDN de jquery-->
    ...
    <body>
        ...
        <div>
            <header style="color:white">Test de conocimientos &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 
        ...
        <div class="solid" id="contenedorTituloYTabla">
            <div class="box" id="contenedorTitulo">
                <h3 id="TituloMantenedor" style="color:white">Mantenedor &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                ...
                var table = $('#tablaUsuarios').DataTable({
                    ...
                    columns: [
                        ...
                        {data: "Estado"},
                        {
                            ...
                            "data": null,
                            "defaultContent":
                                    '<button type="button" value="id_usuario" class="btn-modificar" data-toggle="modal" data-target="#modificarUsuarioModal">Modificar</button>&emsp;'
